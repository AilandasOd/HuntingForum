            ...
            <SidebarContent>
                <List>
                    ...
                    {userGroups.map((group) => (
                        <StyledListItem sx={{ backgroundColor: "#4c634c", borderRadius: "5px", marginBottom: "20px" }} key={group.groupID} button onClick={() => handleGroupClick(group.groupID)}>
